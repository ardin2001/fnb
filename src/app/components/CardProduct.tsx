...
export default function CardProduct({product}:any) {
    return (
        <div className="card bg-base-100 drop-shadow-strong p-2 bg-gray-200">
            <div className="card-body grid gap-1 relative">
                ...
                <Image src={product.image} alt={product.name} width={5000} height={5000} className=" xl:h-52 object-cover" />

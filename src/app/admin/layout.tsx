...
export default function DashboardLayout({
    ...
    return (
        <main className="flex bg-white">
            <Sidebar setOpen={() => setOpen((prev: any) => !prev)} classname={`${open ? "left-0 duration-500 z-50" : "-left-80 duration-500"} ease-in w-64 fixed h-screen px-6 pt-4 pb-14 flex flex-col justify-between bg-white shadow-furdamental shadow-gray-300 overflow-y-auto lg:w-80 lg:sticky`} />

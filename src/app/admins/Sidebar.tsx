        ...
        <aside className={`${classname}`}>
            <div className="grid gap-16">
                ...
                <div className="menu grid">
                    ...
                    <Link onClick={setOpen} href="/admins/products" className={`${pathname === "/admins/products" ? "bg-medium border-l-4 border-secondary" : null} hover:border-l-4 border-secondary`}><p className="pl-4 py-2.5 flex gap-2 text-secondary font-semibold text-lg items-center"><RiAlignItemLeftLine />Products</p></Link>

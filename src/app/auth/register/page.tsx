                    ...
                    <div className="grid gap-5 lg:my-auto sm:w-4/5 lg:w-3/5">
                        ...
                        <form className="form grid gap-3" onSubmit={HandlerRegister}>
                            ...
                            <div className="fullname">
                                <input type="text" id="fullname" name="fullname" className="outline-none py-1.5 bg-white border-b-2 lg:border-2 border-secondary lg:border-white lg:bg-low lg:rounded-md px-2 w-full text-secondary " placeholder="Email" />
                            </div>

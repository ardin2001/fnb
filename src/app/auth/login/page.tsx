            ...
            <div className="grid my-8 mx-10 gap-8 lg:grid-cols-2 lg:drop-shadow-login lg:bg-white">
                ...
                <div className="lg:bg-secondary lg:grid lg:justify-items-center">
                    <div className="lg:my-auto sm:w-4/5 lg:w-3/5 ">
                        <h3 className="text-secondary lg:text-yellow-400 font-bold text-3xl text-center mb-5">Login</h3>
                        <form className="form grid gap-5 lg:gap-4" onSubmit={HandlerLogin}>
                            <div className="email">
                                <input type="text" id="email" className="outline-none py-1.5 bg-white border-b-2 lg:border-2 border-secondary lg:border-yellow-400 lg:rounded-md px-2 w-full text-secondary lg:bg-white" placeholder="Email" />
                            </div>
                            <div className="password">
                                <input type="password" id="password" className="outline-none py-1.5 bg-white border-b-2 lg:border-2 border-secondary lg:border-yellow-400 lg:rounded-md px-2 w-full text-secondary lg:bg-white" placeholder="Password" />
                            </div>
                            <button type="submit" className="bg-secondary lg:bg-yellow-400 py-1 mt-1 text-white lg:text-secondary font-bold rounded-md">Login</button>
                        </form>
                    </div>
                </div>
            </div>
